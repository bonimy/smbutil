...
//	DWORD nWidth,nHeight;
	...
	hBitmap = LoadImage(GetModuleHandle(NULL), TEXT("ASSIST_IMG"), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE | LR_SHARED);
...
//		wsprintf(lpszBuf, GetResourceString(IDS_OBJLIST_PAGECOMMAND, lpbBuf[1]);
		break;
	default://（敵キャラコマンド）
		{
//			LPSTR bit6[]={"", GetResourceString(IDS_OBJLIST_HARD};
